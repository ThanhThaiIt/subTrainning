...
#    * configure driver = { type: 'chrome', headless: false, showDriverLog: true }
    * configure driver = { type: 'chrome', reuse: true, headless: false, showDriverLog: true }
...
#    * waitFor(cartPage.shoppingCartStatus)
